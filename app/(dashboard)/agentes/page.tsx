...
export default function AgentesPage() {
  ...
  return (
    <PageTransition>
      ...
      <div className="grid gap-3 sm:gap-4 grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-[10px] sm:text-xs text-muted-foreground truncate">Academia MAV IA</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg sm:text-xl">Agente Activo</CardTitle>
          <CardDescription className="text-xs sm:text-sm">Información detallada del agente de IA</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4 sm:space-y-6">
            {/* Academia MAV Agent */}
